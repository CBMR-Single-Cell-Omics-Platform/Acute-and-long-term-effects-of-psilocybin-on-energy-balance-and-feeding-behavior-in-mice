...
ggplot_mds(y[, y$samples$tissue == "Hypothalamus"], dim_plot = c(1, 2),
  ...
  geom_label(aes(label = `Sample.ID..Library.ID.`)) +
...
contrast_matrix <- makeContrasts(
  Hyp_Psilocybin_effect_at_3hours = (groupHypothalamus_Saline_3hours - groupHypothalamus_Psilocybin_3hours),
  Hyp_Psilocybin_effect_at_4weeks = (groupHypothalamus_Saline_4weeks - groupHypothalamus_Psilocybin_4weeks),
  ...
  Hyp_Interaction = (groupHypothalamus_Saline_4weeks - groupHypothalamus_Psilocybin_4weeks) - 
    (groupHypothalamus_Saline_3hours - groupHypothalamus_Psilocybin_3hours),
  PFC_Psilocybin_effect_at_3hours = (groupPFC_Saline_3hours - groupPFC_Psilocybin_3hours),
  PFC_Psilocybin_effect_at_4weeks = (groupPFC_Saline_4weeks - groupPFC_Psilocybin_4weeks),
  ...
  PFC_Interaction = (groupPFC_Saline_4weeks - groupPFC_Psilocybin_4weeks) - 
    (groupPFC_Saline_3hours - groupPFC_Psilocybin_3hours),
  levels = v$design
)
